...
def _get_local_eval_file_candidates(args, task: str) -> List[str]:
    ...
    candidates = [
        ...
        os.path.join(data_root, "cr_eval", task, "test.json"),
...
def option_logprob(
    ...
    """Compute log P(option | prompt) by summing token-level log-probs."""
    ...
    log_probs_option = log_probs[:, -L - 1 : -1, :]
